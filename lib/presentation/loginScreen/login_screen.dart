...
import 'package:laboar/core/cubit/loginCubit/login_cubit.dart';
...
import 'package:laboar/presentation/resetScreen/reset_screen.dart';
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DefaultTextFormField(
                              ...
                              suffixImage: LoginCubit.get(context).suffix,
                            ),
                            Space(height: 15.h, width: 0),
                            OnTapFunction(
                              function: () {
                                navigateTo(context, const ResetScreen());
                              },
                              child: Align(
